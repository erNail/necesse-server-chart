# necesse-server-chart

A lightweight Helm chart for hosting Necesse servers that prioritizes
...
```shell
helm install necesse-server oci://ghcr.io/ernail/charts/necesse-server \
--namespace necesse-server \
--create-namespace
```
...
Check the necesse-server documentation for the supported databases.
